...
const LoginButton = ({ handleLogin, Icon, provider, className }) => {

  return (
    <div className='w-full h-max flex flex-col items-center justify-center my-1 hover:scale-[1.03] transition-all duration-500'>
        <button onClick={() => handleLogin()} className={cn("w-full h-[50px] flex items-center rounded-md justify-start pl-[14%] space-x-3", className)}>
